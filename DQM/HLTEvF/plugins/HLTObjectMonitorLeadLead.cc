// -*- C++ -*-
//
// Package:    QM/HLTObjectMonitorLeadLead
// Class:      HLTObjectMonitorLeadLead
//
/**\class HLTObjectMonitorLeadLead HLTObjectMonitorLeadLead.cc DQM/HLTEvF/plugins/HLTObjectMonitorLeadLead.cc 
...
class HLTObjectMonitorLeadLead : public DQMEDAnalyzer {
  struct hltPlot
  {
   ...
   public:
      explicit HLTObjectMonitorLeadLead(const edm::ParameterSet&);
      ~HLTObjectMonitorLeadLead() override;
...
//
HLTObjectMonitorLeadLead::HLTObjectMonitorLeadLead(const edm::ParameterSet& iConfig)
...
HLTObjectMonitorLeadLead::~HLTObjectMonitorLeadLead()
{
...
void
HLTObjectMonitorLeadLead::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
...
void
HLTObjectMonitorLeadLead::dqmBeginRun(edm::Run const& iRun, edm::EventSetup const& iSetup)
{
...
void
HLTObjectMonitorLeadLead::endRun(edm::Run const&, edm::EventSetup const&)
{
  if (debugPrint) std::cout << "Calling endRun. " << std::endl;
}

void HLTObjectMonitorLeadLead::bookHistograms(DQMStore::IBooker & ibooker, edm::Run const& iRun, edm::EventSetup const& iSetup)
{
...
double HLTObjectMonitorLeadLead::get_wall_time()
{
  struct timeval time;
...
/*
void
HLTObjectMonitorLeadLead::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
/*
void
HLTObjectMonitorLeadLead::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
// void
// HLTObjectMonitorLeadLead::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(HLTObjectMonitorLeadLead);
